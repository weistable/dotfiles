...
Kickstart Guide:
  ...
  Next, run AND READ `:help`.
    ...
    which is vH sry useful when you're not sure exactly what you're looking for.
...
vim.keymap.set('n', '<leader>u', ':UndotreeToggle<CR>', { desc = '[un]do tree' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>a', mark.add_file, { desc = '[a]dd mark for file' })
      vim.keymap.set('n', '<leader>sm', ':Telescope harpoon marks<CR>', { desc = '[S]eacrh [M]arked files' })
      vim.keymap.set('n', '<leader>1', function()
        ui.nav_file(1)
      end, { desc = '[1]st file in Harpoon menu' })
      vim.keymap.set('n', '<leader>2', function()
        ui.nav_file(2)
      end, { desc = '[2]nd file in Harpoon menu' })
      vim.keymap.set('n', '<leader>3', function()
        ui.nav_file(3)
      end, { desc = '[3]rd file in Harpoon menu' })
      vim.keymap.set('n', '<leader>4', function()
        ui.nav_file(4)
      end, { desc = '[4]th file in Harpoon menu' })
    end,
  },
  {
